...
const AboutUs = () => {
  return (
    ...
    <div className="bg-gradient-to-r from-blue-50 via-white to-blue-50 min-h-screen py-20 px-6 lg:px-32">
      ...
      <div className="max-w-6xl mx-auto bg-base-300 shadow-lg rounded-2xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
          <div className="p-6 bg-base-300 rounded-xl shadow hover:shadow-md transition duration-300">
        ...
        <p className="mt-10 text-center text-base-content text-lg">
